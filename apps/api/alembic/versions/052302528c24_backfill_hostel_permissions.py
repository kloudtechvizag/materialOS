"""backfill hostel permissions onto existing owner roles

Revision ID: 052302528c24
Revises: 32eb3239f3df
Create Date: 2026-10-02 06:05:00.000000
...
services/permissions.py's RESOURCES gained "hostel" in this same
change. Covers Hostel + HostelRoom + StudentHostelAllocation
together.
"""
...
revision: str = '052302528c24'
down_revision: Union[str, None] = '32eb3239f3df'
