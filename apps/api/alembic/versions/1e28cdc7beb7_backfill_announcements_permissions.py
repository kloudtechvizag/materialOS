"""backfill announcements permissions onto existing owner roles

Revision ID: 1e28cdc7beb7
Revises: d6cc3cd67d33
Create Date: 2026-09-29 06:05:00.000000
...
e9f0a1b2c3d4/b2c3d4e5f6a7: services/permissions.py's RESOURCES gained
"announcements" in this same change.
"""
from typing import Sequence, Union

from alembic import op

revision: str = '1e28cdc7beb7'
down_revision: Union[str, None] = 'd6cc3cd67d33'
