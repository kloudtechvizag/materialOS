"""backfill student_attendance permissions onto existing owner roles

Revision ID: e3f4a5b6c7d8
Revises: d2e3f4a5b6c7
Create Date: 2026-09-23 06:05:00.000000

Same class of gap fixed in a1f4c9e02b7d/c7e1a49f0b6d/b8c9d0e1f2a3/
a9b0c1d2e3f4/c1d2e3f4a5b6: services/permissions.py's RESOURCES gained
"student_attendance" in this same change. ensure_permission_catalog()
only inserts missing Permission rows at app boot / signup -- it never
runs during a migration -- so this migration inserts the new
