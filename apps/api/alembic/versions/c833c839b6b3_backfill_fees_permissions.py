"""backfill fees permissions onto existing owner roles

Revision ID: c833c839b6b3
Revises: 2b5204ab912e
...
e9f0a1b2c3d4: services/permissions.py's RESOURCES gained "fees" in
this same change. One resource covers FeeHead + FeeStructureItem +
FeeInvoice + FeeInvoiceLine together.
"""
from typing import Sequence, Union

from alembic import op

revision: str = 'c833c839b6b3'
down_revision: Union[str, None] = '2b5204ab912e'
