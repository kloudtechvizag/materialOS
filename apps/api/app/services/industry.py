...
PROFILE_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "category": "construction",
        "terminology": {
            "item_label": "Work Item / BOQ Item",
            "items_label": "BOQ Items & Materials",
            "item_name_example": "M25 Grade Reinforced Concrete in Footings",
            "item_uom_example": "CUM",
            "customer_name_example": "National Highway Authority / L&T Realty",
            "supplier_name_example": "Sri Balaji RMC & Steel Suppliers",
        },
        "enabled_modules": [
            "projects",
            "boq",
    ...
    },
    {
        ...
        "enabled_modules": ["sales", "purchase", "inventory", "credit", "collections", "accounting", "gst", "serial_tracking"],
        "navigation_config": [],
        "dashboard_widgets": DEALER_WIDGETS,
    ...
    },
    {
        ...
        "enabled_modules": ["sales", "purchase", "inventory", "pos", "accounting", "gst", "serial_tracking"],
        "navigation_config": [],
    ...
    },
    {
        ...
        "enabled_modules": ["sales", "purchase", "inventory", "pos", "credit", "accounting", "gst", "jewellery", "serial_tracking"],
        "navigation_config": [],
    ...
    },
    {
        ...
        "enabled_modules": ["sales", "purchase", "inventory", "pos", "credit", "collections", "accounting", "gst", "serial_tracking"],
        "navigation_config": [],
        "dashboard_widgets": ["todays_sales", "active_items", "active_customers"],
        "inventory_flags": _flags(serial_tracking=True),
        "pricing_strategy": "pos_mrp_discount",
